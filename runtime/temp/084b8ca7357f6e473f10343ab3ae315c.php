<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"./themes/hdindex/user\team.html";i:1551682237;}*/ ?>
<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="header-right">
      ...
      <div class="page-bd">
        ...
        <?php if(is_array($team) || $team instanceof \think\Collection || $team instanceof \think\Paginator): $i = 0; $__LIST__ = $team;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
       <div class="weui-cell box">
              ...
              <div class="weui-cell__bd">
                ...
                <div class="fs24 color_9">ID <?php echo $user['uid']; ?></div>
              </div>
              <div class="weui-cell__ft">
                <div class="fs30 color_3 fw_b"><?php echo $user['cnt']; ?>人</div>
                <div class="fs24 color_9">团队人数</div>
              </div>
          </div>
