        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form layui-form-pane" action="" method="post">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">注册赠送粮草</label>
                            <div class="layui-input-inline">
                                <input type="text" name="pay_points" placeholder="注册赠送粮草" autocomplete="off" class="layui-input"  value="<?php echo (isset($base_config['pay_points']) && ($base_config['pay_points'] !== '')?$base_config['pay_points']:''); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
