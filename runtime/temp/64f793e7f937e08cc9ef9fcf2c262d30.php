<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"./themes/hdindex/user\safety_center.html";i:1551682237;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="header-right">
      ...
      <div class="page-bd">
        ...
        <div class="weui-cells">
              <a href="set_pwd.html" class="weui-cell weui-cell_access fs28">
                  <div class="weui-cell__bd fw_b color_3">修改登录密码
                  </div>
                  <div class="weui-cell__ft"></div>
                </a>
                <a href="set_paypwd.html" class="weui-cell weui-cell_access fs28">
                    <div class="weui-cell__bd fw_b color_3">设置二级密码
                    </div>
                    <div class="weui-cell__ft"></div>
                  </a>
          </div>
