<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./themes/hdindex/user\blessings_recharge.html";i:1551682237;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="header-right">
      ...
      <div class="page-bd" style="background-color: #fff;">
        ...
        <div class="payimgBox">
            ...
            <img class="recharge_zfb_qrcode" src="<?php echo $ewm['alipay_img']; ?>" alt="" onclick="zfb_qrcode()">
        </div>
        <div class="fromBox">
            <div class="weui-cells weui-cells_form">
                <div class="weui-cells__title  fs28 color_3 fw_b" style="padding-left:0">支付宝收款账号: <span class="fs28 fw_b color_3 account_zfb_number"><?php echo $ewm['alipay_account']; ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="payimgBox">
            ...
            <img class="recharge_wx_qrcode" src="<?php echo $ewm['wechat_img']; ?>" alt="" onclick="wx_qrcode()">
        </div>
        <div class="fromBox">

            <div class="weui-cells weui-cells_form">
                <div class="weui-cells__title  fs28 color_3 fw_b" style="padding-left:0">微信收款账号: <span class="fs28 fw_b color_3 account_wx_number"><?php echo $ewm['wechat_account']; ?></span></div>
...
<script>
    ...
    $('.but').click(function(){
      var url       = '/index/user/blessings_recharge';
      var data      = {};
